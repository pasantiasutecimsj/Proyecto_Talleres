...
const sections = [
  ...
  },
  {
    ...
    items: [
      { label: 'Talleres', desc: 'Listado y mantenimiento', href: route('org.talleres.index') }, // o '/organizador/talleres'
      { label: 'Clases', desc: 'Organizar y crear clases', href: route('org.clases.index') },   // o '/organizador/clases'
    ],
  },
  {
    key: 'docente',
    ...
    items: [
      { label: 'Mis clases', desc: 'Agenda del docente', href: route('doc.clases.index') },     // o '/docente/clases'
      { label: 'Asistentes por clase', desc: 'Ver y marcar asistencia', href: route('doc.clases.gestion') }, // o '/docente/clases/gestion'
    ],
  },
            ...
            <div class="space-y-8">
              <div v-for="section in sections" :key="section.key">
                ...
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" class="w-8 h-8 shrink-0"
                    fill="currentColor" aria-hidden="true">
                    <path
                      d="M480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q125 0 212.5-87.5T780-460q0-125-87.5-212.5T480-760q-125 0-212.5 87.5T180-460q0 125 87.5 212.5T480-160Z" />
                  </svg>
                  <div class="text-left">
